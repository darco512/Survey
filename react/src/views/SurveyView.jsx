                    ...
                    <div className='space-y-6 bg-white px-4 py-5 sm:p-6'>
                        ...
                        <div className='col-span-6 sm:col-span-3'>
                            ...
                            <textarea
                                ...
                                className='mt-1 block w-full rounded-md border-gray-300 shadow-md focus:border-indigo-500 focus:right-indigo-500 sm:text-sm'
                            ></textarea>
                        </div>
                        {/*Description*/}
                        ...
                        <div className='col-span-6 sm:col-span-3'>
                            ...
                            <input 
                                ...
                                className='mt-1 block rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:right-indigo-500 sm:text-sm'
                            />
                        </div>
                        {/*Expire Date*/}
