    ...
    <div>
        ...
        {!loading && (
            <form onSubmit={ev => onSubmit(ev)} className="container mx-auto">
                ...
                {surveyFinished && (
                    <div className=" text-center py-8 px-6 bg-emerald-500 text-white w-[600px] mx-auto">
                ...
                {!surveyFinished && (<>
                    ...
                    <button
                        type='submit'
                        className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounde-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                        Submit
                    </button>
                </>)}
