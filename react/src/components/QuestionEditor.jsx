    ...
    <>
        ...
        <div className="flex justify-between mb-3">
            ...
            <div className="flex items-center">
                <button
                    type="button"
                    className="flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white
        ...
        <div>
            {shouldHaveOptions() && 
                <div>
                    <h4 className="text-sm text-semibold mb-1 flex justify-between items-center">
                        Options

                        <button type="button" 
                            className="flex items-center text-sm py-1 px-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700"
                            onClick={addOption}
                            >
                            Add
                        </button>
