...
class SurveyController extends Controller
{
    ...
    public function show(Survey $survey, Request $request)
    {
        ...
        if ($user->id !== $survey->user_id) {
            return abort(403, 'Unautorised action');
        }
    ...
    public function destroy(Survey $survey, Request $request)
    {
            $user = $request->user();
            if($user->id !== $survey->user_id) {
                return abort(403, 'Unautrized action.');
            }
    ...
    /**
     * Save image in local file system an return saved image path.
     * @param $image
     * @throws \Exception 
     * @author Zura Se
     */
     ...
     * @param $data
     * @return mixed
     * @throws \Illuminate\Validation\VaidationException
     * @author Zura 
     */
