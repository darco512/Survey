          ...
          {meta.total > meta.per_page &&
            ...
            {meta.links && meta.links.map((link, ind)=> (
              ...
              className={
                ...
                + (link.active ? 'z-10 bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-white' : 'focus:outline-offset-0 ring-gray-300 text-gray-900 ring-1 ring-inset  hover:bg-gray-50')
              }
